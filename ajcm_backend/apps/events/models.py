...
class Event(TimeStampedModel):
    ...
    # ==========================================
    # NOUVEAUX CHAMPS POUR L'IA (APPRENTISSAGE CONTINU)
    # ==========================================
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['used_for_ai_training']),  # Pour l'IA
            models.Index(fields=['ai_priority_score']),     # Pour l'IA
        ]
    ...
    def duration_hours(self):
        """Durée en heures (pour l'IA)"""
        return self.Duration.total_seconds() / 3600
    
    @property
    def cost_value(self):
        """Coût en float (pour l'IA)"""
        return float(self.Cost)
    
    @property
    def cost_efficiency(self):
        """Efficacité du coût (formule de l'Excel)"""
        max_cost = 5000  # Valeur max des données d'entraînement
        if max_cost > 0:
    ...
    def volunteer_intensity(self):
        """Intensité bénévole (formule de l'Excel)"""
        max_volunteers = 18  # Valeur max des données d'entraînement
        if max_volunteers > 0:
    ...
    def calculated_priority_score(self):
        """Calcule le Priority Score selon la formule de l'Excel"""
        # Pondération : 50% impact social, 30% efficacité coût, 20% intensité bénévole
        score = (
